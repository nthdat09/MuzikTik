...
public class EventPriceList {
    ...
    public static List<EventPrice> getEventPriceList() {
        ...
        try {
            ...
            String sql = "Select TKT_PRICE, SEAT_TYPE from mctmsys.ticket join mctmsys.seat on ticket.TKT_SEAT_ID = seat.SEAT_ID where TKT_STG_ID = " + selectedStageID + " and TKT_EVT_ID = '" + selectedEventID + "' ";
