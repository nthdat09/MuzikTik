...
public class SwitchMenuControllerCustomer {
    ...
    public SwitchMenuControllerCustomer(JPanel rootPanel) {
    ...
    public void setEvent(List<MenuList> listItem) {
        ...
        for (MenuList item : listItem) {
            item.getJlb().addMouseListener(new SwitchMenuControllerCustomer.LabelEvent(item.getKind(), item.getJpn(), item.getJlb()));
        }
    }
