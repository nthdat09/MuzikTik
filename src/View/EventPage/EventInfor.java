...
public class EventInfor extends JPanel {
    ...
    private void uploadBtnMouseClicked(MouseEvent e) {
        ...
        ImageIcon eventPicture = new ImageIcon(f.toString());
        Image img = eventPicture.getImage().getScaledInstance(260, 100, Image.SCALE_SMOOTH);
        textPoster.setIcon(new ImageIcon(img));
